<?php
	...
	session_start();			//jeśli ktoś już jest zalogowany to odrazu przekierowuje do pliku skleplog
	
	if ((isset($_SESSION['zalogowany'])) && ($_SESSION['zalogowany']==true))
	{
		header('Location: skleplog.php');
		exit();
	}
...
<form method="POST" action="/../PhpProject1/html/controller/zaloguj.php">
        <div class="col-md-3">
     <label >Login: </label>
